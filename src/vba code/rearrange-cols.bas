...
Function getArrayLength(arrList As Variant) As Integer
    If IsEmpty(arrList) Then
      getArrayLength = -1
   Else
      getArrayLength = UBound(arrList) - LBound(arrList)
   End If
End Function
...
Function addValueToArray(arrList As Variant, v As Variant) As Variant
    ...
    If l = 0 Then
        ReDim arrList(0 To 0)
    End If
    ReDim Preserve arrList(0 To l)
    Debug.Print l
    Debug.Print v
    arrList(l) = v
...
arrList = addValueToArray(arrList, 1)
End Function
...
Function getPossibleHeadersSeparated() As Variant
    Dim Headers1 As Variant, Headers2 As Variant, h As Variant
